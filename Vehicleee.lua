...
local TP = Tabs.Players:CreateToggle("TeleportPlr", {Title = "Toggle teleport to selected player", Default = false })
...
local view = Tabs.Players:AddToggle("Viewing", {Title = "Toggle spectate selected player", Default = false })
...
local WsSlider = Tabs.Misc:CreateSlider("WS", {
    Title = "Walk Speed",
    Default = 16,
    Min = 0,
    Max = 100,
...
local WsSlider = Tabs.Misc:CreateSlider("JP", {
    Title = "Jump Power",
    Default = 50,
    Min = 0,
    Max = 150,
...
local tgThings = Tabs.Misc:CreateToggle("TGTHINGS", {Title = "Toggle Custom Status", Default = false })

tgThings:OnChanged(function(bool)
    local Hum = getHum()
